...
<header>
  <div class="header_flex">
    ...
    <div class="">
      <ul class="header_left">
        ...
        <a href=""><li class="nav_icon"><img src="../img/door.png" alt="icon" height="30px" width="30px"></li></a>
      </ul>
    </div>
 </div>
  </header>
  <div class="main_container">
      <div class="msg">
       ...
       <!-- <a href="detail.php?id=<?php print(htmlspecialchars($post['id']));?>"><img src="../img/pen.png" height="20px" width="20px"></a> -->
