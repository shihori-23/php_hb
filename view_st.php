...
<div id="wrap">
  ...
  <?php if($post = $posts->fetch()): ?>
    ...
    ?>
      ...
      <a class="d_icon" href="detail_st.php?id=<?php print(htmlspecialchars($post['id']));?>"><img src="img/pen.png" height="25px" width="25px"></a>
      </div>
  ...
  <?php endif; ?>
      <p><a class="nav_btn" href="main_st.php">一覧にもどる</a></p>
