...
if (!empty($_POST)){
 ...
 if (empty($error)) { 
	...
	$_SESSION['join'] = $_POST;
	header('Location: kanri_insert.php');
	exit();
	}
}
...
<form class="form-horizontal form_container" method="POST" action="">
     <legend class="title">Staff Account</legend>
  <div class="form-group">
   ...
   <?php if ($error['email'] === 'duplicate'): ?>
    ...
    <label>Salon<?php if ($error['salon'] === 'blank'): ?>
		...
		<?php endif; ?></label>
    <input class="form-control" type="text" name="salon" placeholder="サロン名を入力してください"  value="<?php print(htmlspecialchars($_POST['salon'],ENT_QUOTES)); ?>"><br>
