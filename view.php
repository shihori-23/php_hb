...
$posts = $pdo->prepare('SELECT * FROM posts WHERE member_id=:member_id AND id=:post_id');
...
<div id="wrap">
  ...
  <?php if($post = $posts->fetch()): ?>
    ...
    ?>
      ...
      <a class="d_icon" href="detail.php?id=<?php print(htmlspecialchars($post['id']));?>"><img src="img/pen.png" height="25px" width="25px"></a>
      <a class="d_icon" href="delete.php?id=<?php print(htmlspecialchars($post['id']));?>"><img src="img/dust.png" height="25px" width="25px"></a>
      </div>
  ...
  <?php endif; ?>
      <p><a class="nav_btn" href="main.php">一覧にもどる</a></p>
