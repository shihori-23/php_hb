...
$posts = $pdo->prepare('SELECT * FROM posts WHERE salon=:val ORDER BY date DESC');
...
<header>
  ...
  <div class="main_container">
    ...
    <?php foreach ($post as $p): ?>
     <a href="view_st.php?id=<?php print(htmlspecialchars($p['id'])); ?>">
      <div class="msg">
      <p class="msg_p"><?php print(htmlspecialchars($p['salon'],ENT_QUOTES)); ?></p>
      <p class="msg_p"><?php print(htmlspecialchars($p['name'],ENT_QUOTES)); ?></p>
